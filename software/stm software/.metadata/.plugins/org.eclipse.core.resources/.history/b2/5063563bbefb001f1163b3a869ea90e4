...
AI_ALIGNED(4) ai_i8 data_in_1[AI_EMGCLASSIFIER_IN_1_SIZE_BYTES];
ai_i8* data_ins[AI_EMGCLASSIFIER_IN_NUM] = {
data_in_1
};
#else
ai_i8* data_ins[AI_EMGCLASSIFIER_IN_NUM] = {
...
AI_ALIGNED(4) ai_i8 data_out_1[AI_EMGCLASSIFIER_OUT_1_SIZE_BYTES];
ai_i8* data_outs[AI_EMGCLASSIFIER_OUT_NUM] = {
data_out_1
};
#else
ai_i8* data_outs[AI_EMGCLASSIFIER_OUT_NUM] = {
...
AI_ALIGNED(32)
static uint8_t pool0[AI_EMGCLASSIFIER_DATA_ACTIVATION_1_SIZE];

ai_handle data_activations0[] = {pool0};

/* AI objects ----------------------------------------------------------------*/

static ai_handle emgclassifier = AI_HANDLE_NULL;
...
int acquire_and_process_data(ai_i8* data[])
{
  ...
  for (int idx=0; idx < AI_NETWORK_1740727433501_IN_NUM; idx++ )
  {
      data[idx] = ....
  }
...
int post_process(ai_i8* data[])
{
  ...
  for (int idx=0; idx < AI_NETWORK_1740727433501_OUT_NUM; idx++ )
  {
      data[idx] = ....
  }
