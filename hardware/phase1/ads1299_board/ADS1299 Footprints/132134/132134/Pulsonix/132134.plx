...
(library Library_1
	...
	(compDef "132134" (originalName "132134") (compHeader (numPins 5) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-DGA15/760440.pdf")
		(attr "<Component Height>" "9.53")
		(attr "<STEP Filename>" "132134.stp")
