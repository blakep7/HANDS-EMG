/**
  ...
  ******************************************************************************
  */
#ifndef AI_NETWORK_1740727433501_H
#define AI_NETWORK_1740727433501_H

#include "network_1740727433501_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_1740727433501_MODEL_NAME          "network_1740727433501"
#define AI_NETWORK_1740727433501_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_NETWORK_1740727433501_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_1740727433501_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_1740727433501_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_1740727433501_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_1740727433501_IN \
  ai_network_1740727433501_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_1740727433501_IN_SIZE { \
  AI_NETWORK_1740727433501_IN_1_SIZE, \
}
#define AI_NETWORK_1740727433501_IN_SIZE_BYTES { \
  AI_NETWORK_1740727433501_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_1740727433501_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_1740727433501_IN_1_CHANNEL     (48)
#define AI_NETWORK_1740727433501_IN_1_SIZE        (48)
#define AI_NETWORK_1740727433501_IN_1_SIZE_BYTES  (192)

/******************************************************************************/
#define AI_NETWORK_1740727433501_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_1740727433501_OUT \
  ai_network_1740727433501_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_1740727433501_OUT_SIZE { \
  AI_NETWORK_1740727433501_OUT_1_SIZE, \
}
#define AI_NETWORK_1740727433501_OUT_SIZE_BYTES { \
  AI_NETWORK_1740727433501_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_1740727433501_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_1740727433501_OUT_1_CHANNEL     (18)
#define AI_NETWORK_1740727433501_OUT_1_SIZE        (18)
#define AI_NETWORK_1740727433501_OUT_1_SIZE_BYTES  (72)

/******************************************************************************/
#define AI_NETWORK_1740727433501_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_1740727433501
 ...
 * @ref ai_network_1740727433501_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_1740727433501_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_1740727433501_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_1740727433501_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_1740727433501_*
 * defines into file @ref network_1740727433501.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_1740727433501_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_1740727433501_H */
