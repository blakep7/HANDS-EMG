/**
  ...
  ******************************************************************************
  */
#ifndef AI_EMGCLASSIFIER_H
#define AI_EMGCLASSIFIER_H

#include "emgclassifier_config.h"
...
#define AI_EMGCLASSIFIER_INPUTS_IN_ACTIVATIONS   (4)
#define AI_EMGCLASSIFIER_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_EMGCLASSIFIER_IN_NUM        (1)

AI_DEPRECATED
#define AI_EMGCLASSIFIER_IN \
  ai_emgclassifier_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_EMGCLASSIFIER_IN_SIZE { \
  AI_EMGCLASSIFIER_IN_1_SIZE, \
}
#define AI_EMGCLASSIFIER_IN_SIZE_BYTES { \
...
AI_DEPRECATED
#define AI_EMGCLASSIFIER_OUT \
  ai_emgclassifier_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_EMGCLASSIFIER_OUT_SIZE { \
  AI_EMGCLASSIFIER_OUT_1_SIZE, \
}
#define AI_EMGCLASSIFIER_OUT_SIZE_BYTES { \
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_emgclassifier_get_info(
 ...
 */
AI_API_ENTRY
ai_bool ai_emgclassifier_get_report(
  ai_handle network, ai_network_report* report);
 ...
 */
AI_API_ENTRY
ai_handle ai_emgclassifier_destroy(ai_handle network);
 ...
 * @ref ai_emgclassifier_create. Both the activations memory buffer 
 ...
 * using @ref ai_emgclassifier_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_emgclassifier_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_emgclassifier_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_EMGCLASSIFIER_*
 * defines into file @ref emgclassifier.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_emgclassifier_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_EMGCLASSIFIER_H */
