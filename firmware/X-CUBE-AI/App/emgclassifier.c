...
#include "emgclassifier.h"
#include "emgclassifier_data.h"
...
#define AI_TOOLS_DATE_TIME   "2025-02-27T23:42:10-0800"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_EMGCLASSIFIER_N_BATCHES
#define AI_EMGCLASSIFIER_N_BATCHES         (1)

static ai_ptr g_emgclassifier_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_emgclassifier_weights_map[1] = AI_C_ARRAY_INIT;
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_EMGCLASSIFIER_MODEL_NAME,
      .model_signature   = AI_EMGCLASSIFIER_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_i32 ai_emgclassifier_forward(ai_handle network, const ai_buffer* input)
{
