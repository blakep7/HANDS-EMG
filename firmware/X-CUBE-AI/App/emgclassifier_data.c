...
ai_buffer ai_emgclassifier_data_activations_buffer_get(const ai_handle ptr)
{
  ai_buffer buf = AI_BUFFER_INIT(
    ...
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, AI_EMGCLASSIFIER_DATA_ACTIVATIONS_SIZE, 1, AI_EMGCLASSIFIER_DATA_ACTIVATIONS_COUNT),
    AI_EMGCLASSIFIER_DATA_ACTIVATIONS_SIZE,
    NULL, ptr);
  return buf;
}
...
ai_buffer ai_emgclassifier_data_weights_buffer_get(const ai_handle ptr)
{
  ai_buffer buf = AI_BUFFER_INIT(
    ...
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, AI_EMGCLASSIFIER_DATA_WEIGHTS_SIZE, 1, AI_EMGCLASSIFIER_DATA_WEIGHTS_COUNT),
    AI_EMGCLASSIFIER_DATA_WEIGHTS_SIZE,
    NULL, ptr);
  return buf;
}
...
{
  return AI_HANDLE_PTR(g_emgclassifier_weights_table);
